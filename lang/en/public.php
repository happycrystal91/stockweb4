...
return [
    ...
    "fixed income 3"    => "Our strategy concentrates on issuers of debt in key market sectors, such as:
                            <br>
                            • Corporate debt
                            <br>
                            ...
                            <br>
                            • U.S. Treasuries",
    "fixed income 4"   => "Independent credit research that identifies exceptional value across fixed-income sectors.",
    "fixed income 5"   => "Bottom-up credit research designed to identify subsectors of the U.S. municipal bond market with strong value.",
    "fixed income 6"   => "Actively managed &Prime;Pure Play&Prime; strategy employed in the inflation-indexed market.",
    ...
    "custody & fund services 3"     => "Offering comprehensive depositary services for Luxembourg, Irish, Cayman and Hong Kong domiciled funds.",
    "custody & fund services 4"     => "Supporting complex investment types, fee calculations, and service models across a fund domiciles and jurisdictions.",
    "custody & fund services 5"     => "Providing a comprehensive suite of administrative services with a flexible approach to support our clients’ needs.",
    ...
    "specialist expertise 3"    => "Working with asset managers to provide comprehensive modular solutions for US Funds that meet their evolving needs across the middle and back office.",
    "specialist expertise 4"    => "Partnering with intermediaries to better serve clients.",
    "specialist expertise 5"    => "Providing distribution intelligence to assist asset managers in developing and executing their distribution strategies.",
    "specialist expertise 6"    => "Providing comprehensive fund services for all major alternative asset classes and strategies.",
    "specialist expertise 7"    => "Working with a diverse group of asset managers to introduce and administer global and regional ETF products.",
    "specialist expertise 8"    => "Providing insurance expertise and strategic services to sophisticated global (re)insurers and asset managers.",
    ...
    "what we look for 4" => "We are interested in exceptional, success-driven individuals who are excited to lead a collaborative environment that fosters our values of Teamwork, Integrity, and Excellence.",
    ...
    "total rewards 3"   => "Career ownership with the support you need to nurture your long-term professional passion.",
    "total rewards 4"   => "Opportunities to expand your skills and knowledge through collaborative learning, on-the-job
    ...
    "life here 3" => "A unique culture that emphasizes Teamwork, Integrity, and Excellence—the values that drive our success.",
