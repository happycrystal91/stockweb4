...
<html lang="zxx">
    <head>
        ...
        <!-- style start -->
        <link href="{{ asset('main/css/plugins.css') }}" media="all" rel="stylesheet" type="text/css">
        <link href="{{ asset('main/css/style.css') }}" media="all" rel="stylesheet" type="text/css">
        <!-- style end -->
        <!-- google fonts start -->
    ...
    <body>
        ...
        <script src="{{ asset('main/js/luxex.js') }}"></script>
        <!-- scripts end -->
    </body>
</html>