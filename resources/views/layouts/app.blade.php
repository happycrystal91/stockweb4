...
<html lang="zxx">
    ...
    <body>
        ...
        <!-- tst line start -->
        @include('layouts.partials._tst-line')

        <!-- border top start -->
        <!-- container start -->
        @include('layouts.partials._border-top')
        ...
        //                 <p>*Vanward International is owned by its funds, which are owned by Vanward International's fund shareholder clients.</p>
